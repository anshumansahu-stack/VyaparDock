...
const Hero = () => {
  return (
    <div style={{ backgroundImage: `url(${herobg})`, backgroundSize: 'cover', backgroundPosition: 'center' }} className='flex flex-col items-center rounded-[45px] justify-center h-115 px-30 pt-10 w-2/3 gap-25 mt-4'>
      <p style={{ textShadow: '3px 3px 4px black', WebkitTextStroke: '1px black'}} className='text-white font-[Sedgwick_Ave] font-bold text-[65px] text-center w-11/12 animate-bounce'>Kickstart your career in today's Corporate world!</p>
