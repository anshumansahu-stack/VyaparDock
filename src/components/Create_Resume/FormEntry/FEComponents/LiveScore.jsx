...
const LiveScore = (props) => {
  ...
  return (
    <div className={"backdrop-blur-md bg-black/50 w-full min-h-3/20 rounded-t-2xl flex flex-col justify-center items-left font-['Freeman'] font-bold text-[43px] text-center text-indigo-100 relative print:hidden " + (props.className || '')} >
